...
| Dataset documentation | Real evidence source, tested scope, observed findings, and limitations are documented. | Bounded registry content is documented; event/timeline and deeper registry analysis remain open. |
