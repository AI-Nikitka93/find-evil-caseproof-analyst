...
| Dataset documentation | `docs/dataset_documentation.md`, `docs/research_sift_mcp.md` | Present with limits | Full Plaso timeline and deeper process/account corroboration remain open. | Dataset doc stays honest after public link audit. |
...
| Accuracy validation | `verify_claim` tool, `docs/accuracy_report.md` | Present with limits | Bounded registry, event, and correlation content are validated; full Plaso timeline and deeper process/account corroboration are not validated. | Every confirmed bounded-run finding keeps evidence support and verifier status. |
