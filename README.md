...
| Final local package | Prepared with external gates | Devpost text, demo script, judge runbook, quality matrix, judge max readiness report, and go/no-go board are in `docs/` |
