...
def test_sanitized_public_trace_removes_local_paths_and_keeps_correction() -> None:
    records = [
        ...
        },
        {
            ...
            "agent_intent": "Parse event content.",
            "tool_name": "extract_event_records",
            "parser_status": "ok",
            "arguments": {"event_log_paths": ["exports/Security.evtx"], "event_ids": [4624, 4625]},
            "evidence_id": "ev-local",
        ...
        },
        {
            ...
            "run_id": "real-1",
            "step_number": 6,
            "timestamp_utc": "2026-05-06T00:00:05Z",
    ...
    log.write_text(
        "\n".join(
            [
                ...
                '{"step_number":5,"timestamp_utc":"2026-05-06T00:00:04Z","agent_intent":"events","tool_name":"extract_event_records","parser_status":"ok","arguments":{},"evidence_id":"ev","output_reference":"exports/event_content_summary.json","correction_reason":null,"token_usage":null,"run_id":"r"}',
                '{"step_number":6,"timestamp_utc":"2026-05-06T00:00:05Z","agent_intent":"verify","tool_name":"verify_claim","parser_status":"ok","arguments":{},"evidence_id":"ev","output_reference":"reports/correction_ledger.md","correction_reason":"Unsupported compromise claim dropped from confirmed findings.","token_usage":null,"run_id":"r"}',
            ]
        )
        + "\n",
        encoding="utf-8",
